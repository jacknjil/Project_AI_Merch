  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto py-10 space-y-12">
        <section>
          <h1 className="text-4xl font-bold mb-6 font-heading">Design System</h1>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl">
            This page verifies the implementation of design tokens, typography, and base components.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4">
            <div>
              <h1 className="text-4xl font-bold font-heading">Heading 1 (Inter)</h1>
              <p className="text-sm text-gray-500">font-heading / 4xl / bold</p>
            </div>
            <div>
              <h2 className="text-2xl font-semibold font-heading">Heading 2 (Inter)</h2>
              <p className="text-sm text-gray-500">font-heading / 2xl / semibold</p>
            </div>
            <div>
              <p className="text-base font-body">
                Body text (Roboto). Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
